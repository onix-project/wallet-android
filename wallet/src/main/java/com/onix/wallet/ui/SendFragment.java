...
import com.onix.core.coins.FiatType;
...
import static com.onix.core.coins.Value.canCompare;
import static com.onix.wallet.ExchangeRatesProvider.getRates;
import static com.onix.wallet.util.UiUtils.setGone;
import static com.onix.wallet.util.UiUtils.setVisible;
    ...
    private final LoaderCallbacks<Cursor> rateLoaderCallbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        public void onLoadFinished(final Loader<Cursor> loader, final Cursor data) {
            if (data != null && data.getCount() > 0) {
                HashMap<String, com.onix.core.util.ExchangeRate> rates = new HashMap<>(data.getCount());
                data.moveToFirst();
                do {
